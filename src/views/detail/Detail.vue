...
.item-attr-info .item-attr{
  margin-bottom: 10px;
}
.item-attr-info .item-attr h2{
  padding: 0;
  margin-bottom: 12px;
}
.item-attr-info .item-attr .product-attrs {
  display: flex;
  justify-content: space-between;
  flex-flow: row wrap;
}
.item-attr-info .item-attr .product-attrs .product-attr {
  width: 287px;
  height: 50px;
  line-height: 50px;
  font-size: 16px;
...
.item-attr-info .item-attr .product-attrs .product-attr.checked{
